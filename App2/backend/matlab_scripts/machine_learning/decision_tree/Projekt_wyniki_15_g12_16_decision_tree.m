function result = Projekt_wyniki_15_g12_16_decision_tree()
clc;
clear variables;

% Wczytanie danych 
[X, Y] = ReadData_wyniki_15_g12_16_decision_tree();
...
title('Actual vs Predicted WeldTempPiro (Decision Tree) - 12-16');
xlabel('Sample');
ylabel('Temperature');
hold off;
