function result = Projekt_wyniki_15_g10_12_boosted()
clc;
clear variables;

[X, Y] = ReadData_wyniki_15_g10_12_boosted();
...
title('Actual vs Predicted Welding Temperature (Boosting Model) - 10-12');
xlabel('Sample');
ylabel('Temperature');
hold off;
