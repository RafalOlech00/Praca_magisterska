function result = Projekt_wyniki_15_g10_12_neural_network()
clc;
clear variables;
...
filename = 'wyniki_15_g10_12.xlsx';
...
title('Actual vs Predicted Welding Temperature (Neural Network) - 10-12');
xlabel('Sample');
ylabel('Temperature');
hold off;
